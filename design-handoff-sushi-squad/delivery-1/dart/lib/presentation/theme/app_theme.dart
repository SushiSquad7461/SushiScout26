...
abstract final class AppTheme {
  ...
  static ThemeData light(TeamBrand brand) =>
  ...
  static TextStyle numeral(TeamBrand brand, {double size = 54, Color? color}) =>
      display(brand, size: size, color: color).copyWith(
  ...
  static TextTheme textTheme(TeamBrand brand, Color onSurface, Color muted) {
    return TextTheme(
      displayLarge: display(brand, size: 46, letterSpacing: -0.01, height: 0.94, color: onSurface),
      displayMedium: display(brand, size: 40, letterSpacing: -0.01, height: 0.96, color: onSurface),
      ...
      titleLarge: display(brand, size: 21, letterSpacing: 0.01, color: onSurface),
      titleMedium: display(brand, size: 17, letterSpacing: 0.02, color: onSurface),
      titleSmall: display(brand, size: 15, letterSpacing: 0.02, color: onSurface),
      ...
      labelLarge: display(brand, size: 17, letterSpacing: 0.02, color: onSurface),
      labelMedium: display(brand, size: 15, letterSpacing: 0.02, color: onSurface),
  ...
  static Color get allianceRed => TeamBrands.fallback.allianceRed;
  static Color get allianceBlue => TeamBrands.fallback.allianceBlue;

  // The old seed swatches. Kept only so `settings_sheet.dart` still compiles
  // before its colour picker is replaced by the brand picker; delete both the
  // picker and these together.
  @Deprecated('Colour is no longer seeded. Use TeamBrands.all.')
  ...
  @Deprecated('Colour is no longer seeded. Use AppTheme.brandFor(id).')
  static Color getSeedColor(String? colorName) =>
      TeamBrands.byId(colorName).accentHighlight;

  @Deprecated('Use AppTheme.light(brand).')
  static ThemeData lightTheme(Color _) => light(TeamBrands.fallback);

  @Deprecated('Use AppTheme.dark(brand).')
  static ThemeData darkTheme(Color _) => dark(TeamBrands.fallback);
}
